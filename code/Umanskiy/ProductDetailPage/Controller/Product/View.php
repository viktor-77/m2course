...
namespace Umanskiy\ProductDetailPage\Controller\Product;
...
class View extends ProductAction implements HttpGetActionInterface, HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $hasAttribute = $product->getCustomAttribute('featured');
            if ($hasAttribute && $hasAttribute->getValue()) {
                $page->getLayout()->getUpdate()->addHandle('featured_product');
            }
